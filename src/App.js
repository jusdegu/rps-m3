...
function ButtonComponent(props) {
  ...
  return (
    <div class="rowwide">
      <div>
        <h2>Welcome {props.p1Name}!</h2>
      </div>
      <div>
        <h3>Click a button.</h3>
      </div>
      <div class="rowslol">
        <div class="button" onClick={() => myClick("Rock")}>
          <img src={rock} className="img-button" alt="rock" />
        </div>
        <div class="button" onClick={() => myClick("Paper")}>
          <img src={paper} className="img-button" alt="paper" />
        </div>
        <div class="button" onClick={() => myClick("Scissors")}>
          <img src={scissors} className="img-button" alt="scissors" />
        </div>
      </div>
    </div>
  );
...
class App extends Component {
  ...
  analyze = () => {
    ...
    if (
      (this.state.p1Choice === "Rock" && this.pcChoice === "Scissors") ||
      (this.state.p1Choice === "Paper" && this.pcChoice === "Rock") ||
      (this.state.p1Choice === "Scissors" && this.pcChoice === "Paper")
    )
      return 1;
    else if (this.state.p1Choice === this.pcChoice) return 3;
    else return 2;
  };
      ...
      if (playerWon === 1) {
        result = (
          <div>
            <h1>You win!</h1>{" "}
            <h2>
              You selected {this.state.p1Choice}. PC selected {this.pcChoice}
            </h2>
          </div>
        );
      } else if (playerWon === 2) {
